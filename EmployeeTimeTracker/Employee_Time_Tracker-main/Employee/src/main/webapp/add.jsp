...
<script>
  ...
  document.getElementById('date_1').addEventListener('change', function() {
	    ...
	    if (dateInput < currentDate) {
	      alert('Cannot select a date earlier than today.');
	      document.getElementById('date_1').value = currentDate; // Set date back to today
	    }
	  });
	  ...
	  document.getElementById('taskForm').addEventListener('submit', function(event) {
	    ...
	    // Simulate form submission success (replace with actual form submission logic)
	    // For demonstration purposes, show modal after a short delay
	    setTimeout(function() {
